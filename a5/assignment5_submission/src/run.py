...
if args.function == 'pretrain':
    ...
    Hyperparameters = trainer.TrainerConfig(
        max_epochs=650,
        batch_size=128,
        learning_rate=args.pretrain_lr,
        lr_decay=True,
    ...
    trainer.Trainer(model, pretrain_dataset, None, Hyperparameters).train()
    ...
    if args.eval_corpus_path is not None:
        ...
        eval_dataset = None
    trainer.Trainer(model, finetune_dataset, eval_dataset, hyperparameters).train()
    torch.save(model.state_dict(), args.writing_params_path)
